...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const adminMenuItems = [
    { path: '/admin/dashboard', icon: LayoutDashboard, label: 'Dashboard', roles: ['super_admin', 'direccion', 'finanzas', 'gerente_ops', 'admin'] },
    { path: '/admin/rentas', icon: FileText, label: 'Rentas', roles: ['super_admin', 'direccion', 'finanzas', 'gerente_ops', 'secretaria', 'coordinador', 'admin'] },
